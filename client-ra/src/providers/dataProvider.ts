...
import memberDataProvider from "./memberDataProvider"; // file members
...
const dataProvider: DataProvider = {
  getList: async (resource, params: GetListParams) => {
    ...
    if (resource === "members") return memberDataProvider.getList(resource, params);
  ...
  getOne: async (resource, params: GetOneParams) => {
    ...
    if (resource === "members") return memberDataProvider.getOne(resource, params);
  ...
  create: async (resource, params: CreateParams) => {
    ...
    if (resource === "members") return memberDataProvider.create(resource, params);
  ...
  update: async (resource, params: UpdateParams) => {
    ...
    if (resource === "members") return memberDataProvider.update(resource, params);
  ...
  delete: async (resource, params: DeleteParams<any>) => {
    ...
    if (resource === "members") return memberDataProvider.delete(resource, params);
  ...
  deleteMany: async (resource, params) => {
    ...
    if (resource === "members") return memberDataProvider.deleteMany(resource, params);
  ...
  getManyReference: async (resource, params) => {
    ...
    if (resource === "members" && memberDataProvider.getManyReference) return memberDataProvider.getManyReference(resource, params);
  ...
  updateMany: async (resource, params) => {
    ...
    if (resource === "members" && memberDataProvider.updateMany) return memberDataProvider.updateMany(resource, params);
